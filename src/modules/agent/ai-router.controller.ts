...
export const createConversationHandler = asyncHandler(async (req: Request, res: Response) => {
  ...
  const conversation = await createConversation(userId, body.network, body.title);
...
export const getMessagesHandler = asyncHandler(async (req: Request, res: Response) => {
  ...
  res.json({ data: messages, pagination: { total, limit: query.limit, offset: query.offset } });
});
...
export const renameConversationHandler = asyncHandler(async (req: Request, res: Response) => {
  ...
  const conversation = await renameConversation(req.params.id as string, userId, body.title);
